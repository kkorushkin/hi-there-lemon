...
class ControllerExtensionTotalDiscount extends Controller {
	...
	public function index() {
        ...
        if(isset($this->request->post['total_discount_amount'])) {
            $data['total_discount_amount'] = $this->request->post['total_discount_amount'];
        }else {
            $data['total_discount_amount'] = $this->config->get('total_discount_amount');
        }

        if(isset($this->request->post['total_discount'])) {
            $data['total_discount'] = $this->request->post['total_discount'];
        }else {
            $data['total_discount'] = $this->config->get('total_discount');
        }
